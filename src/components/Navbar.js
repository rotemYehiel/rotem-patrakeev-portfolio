...
const Navbar = ({ email }) => {
    ...
    return (
        <div className="navbar header-item">
            <Link className="nav-link" to="/" onClick={() => dispatch(toggalMenu())}>Home</Link>
            <Link className="nav-link" to="/About" onClick={() => dispatch(toggalMenu())}>About</Link>
            <Link className="nav-link" to="/Experience" onClick={() => dispatch(toggalMenu())}>Experience</Link>
